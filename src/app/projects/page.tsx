                ...
                {projects.length === 0 ? (
                    ...
                    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                        {projects.map((project) => (
                            <article
                                key={project._id}
                                className={`group border rounded-lg overflow-hidden bg-white/[0.02] hover:bg-white/[0.04] transition-colors ${project.featured ? 'border-blue-500/50' : 'border-white/10'
                                    }`}
                            >
                                {project.thumbnail && (
